...
2. При этом есть ограничения на разрешенные символы пароля ❌
...
1. Есть проверка на чрезмерно большую длину имени (макс. 25 символов) ✅
#### Пол
1. Только М или Ж ✅
#### Город
...
#### Работа
1. Есть категории на выбор "Программист", "Учитель", "Уборщик", "Прапорщик", "Сварщик" ✅
#### Образование
1. Есть варианты выбора: "МГТУ им. Н.Э. Баумана", "Среднее общее", "Среднее профессиональное", "Основное общее", "Высшее неоконченное" ✅
