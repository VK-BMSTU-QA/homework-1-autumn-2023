...
**Пример:** [Гоавная страница](https://sub-me.ru/)
...
7. При корректном вводе старого **пароля** и нового латинницой/кириллицей, содержащего число и длиннее 7 и короче 21 символа, и нажатии кнопки "сохранить", данные сохраняются и
   выводится сообщение об успешном сохранении.
8. При обновлении **фото профиля** на jpeg/jpg/png размером менее 5 МБ, фото успешно обновляется.
9. При нажатии на кнопку "Удалить" у **фото профиля**, фото успешно удаляется.
...
3. При вводе пустого **имени пользователя** и нажатии кнопки "сохранить" выводится сообщение о некорректной длине
   введённых
   данных.
4. При вводе **имени пользователя**, содержащего символ отличный от кириллицы/латинницы(например, emoji), и нажатии кнопки "сохранить", данные не сохраняются
   и выводится сообщение о том, что введённые данные некорректны.
...
7. При вводе пустого **логина** и нажатии кнопки "сохранить" выводится сообщение о некорректной длине
   введённых
   данных.
8. При вводе **логина**, содержащего символ отличный от кириллицы/латинницы(например, emoji), и нажатии кнопки "сохранить", данные не сохраняются
   и выводится сообщение о том, что введённые данные некорректны.
...
16. При вводе нового **пароля**, содержащего символы отличные от латинницы/кириллицы(например, emoji), и нажатии кнопки "сохранить" выводится сообщение о некорректных данных.
17. При нажатии на кнопку "Удалить" у **фото профиля**, если у пользователя нет фото, ссообщение об ошибке не выводится.(баг)
18. При загрузке нового **фото профиля** размером более 5 Мб отображается сообещние об ошибке.