...
- Телефон
  - Если телефон имеет неверный формат, то после сохранения
    ...
    - никаких подсказок не появляется
...
- ${\color{red} При \ заполнении \ поля \ "Телефон" \ номером \ из \ 12 \ цифр, \ подсказдка \ не \ появляется, \ но \ в \ профиле \ отображаются \ только \ первые \ 11 \ символов }$
...
- При попытке создать мероприятие с временем начала позже времени окончания
  - Мероприятие не создаётся
  - Появляется посказка "Время окончания мероприятия не может быть раньше времени начала"
- Создание места
  - При попытке создать место без названия
    - Место не создаётся
    - Появляется посказка "Введите имя!"
  - При попытке создать место без геопозиции
    - Место не создаётся
    - Появляется посказка "Выберите место на карте!"
...
- При попытке создать мероприятие без картинки
  - Мероприятие не создаётся
  - Появляется посказка "Добавьте картинку"
...
- При попытке изменить дату окончания мероприятия на дату в прошлом
  ...
  - Появляется посказка "Мероприятие неактуально"
