...
- При попытке сохранить пин на доску, на которой он уже есть, появляется попап, с сообщением "The pin has already been saved on this board"
...
- При сохранении нового username длиной более 3 символов - username сохраняется.
- При сохранении нового Name длиной более 1 символа - Name сохраняется.
