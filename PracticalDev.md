...
- При длинном имени пользователя оно не обрезается и аватар пользователя становится не пропорциональным ![](./img/pin_user_img_bug.png). Пример корректного отображения ![](./img/pin_user_img_ok.png)
