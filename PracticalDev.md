...
- При вводе незарегистрированной почты на запрос аворизации появляется сообщение "Wrong email or password"
- При вводе неправильного пароля и зарегистрированной почты появляется сообщение "Wrong email or password"

**Негативные кейсы:**

- При попытке ввести некорректную почту, появляется сообщение сообщение с просьбой ввести почту.
...
- При попытке сохранить пин на доску, на которой он уже есть, появляется уведомление, с сообщением "The pin has already been
  saved on this board"
...
- При создании доски через вкладку с досками в профиле, спискок досок пользователя не обновляется
