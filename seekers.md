## Регистрация
[Регистрация](https://mailbx.ru/signup)
...
- При корректных данных и уникальном логине при нажатии "Создать" пользователь будет авторизован и перенаправлен на главную страницу.
- При регистрации у пользователя обновляется аватар на дефолтный с первам символом из имени 
- При клике на ссылку [Войти](https://mailbx.ru/login) пользователь будет направлен на страницу авторизации
...
## Авторизация
[Авторизация](https://mailbx.ru/login)
...
- При клике на ссылку [Зарегистрироваться](https://mailbx.ru/signup) пользователь будет направлен на страницу регистрации
...
## Профиль
[Профиль](https://mailbx.ru/profile)
...
- При изменении имени на другое, у которого отличается первый символ, в случае дефолтной аватарки, аватарка меняется на актуальную с 1 символом
...
## Пароль
[Профиль](https://mailbx.ru/security)
- При нажатии "Сохранить" в случае пустого инпута всплывает подсказка заполнить поле.
- При вводе пароля короче 5 символов снизу появляется подсказка "Пароль короче 5 символов"
...
**Действия с папкой**
 - При нажатии правой кнопки мыши на папку всплывает окно с кнопками:
   - При нажатии на кнопку "Переименовать" всплывает окошко с предложением выбрать имя папки
   - При нажатии кнопки создать:
     - Меняется имя папки
     - При пустом поле вылетает ошибка с просьбой ввести название папки
   - При нажатии кнопки "Отменить":
     - Закрывается окошко с предложением выбрать имя папки
   - При нажатии на кнопку "Удалить" вылетает окошко с подтверждением выбора:
 ...
 - При нажатии на папку:
   - Страница показывает письма, которые находятся в этой папке
**Стандартные папки**
...
## Список писем
**Действия с письмами**
 - При нажатии на письмо левой кнопкой мыши:
   - Открывается страница письма
 - При нажатии на письмо правой кнопкой мыши:
   - Открывается диалоговое окно с действиями:
     - При нажатии на кнопку "Переслать" открывается страница создания письма с заполненным текстом
     - При нажатии на кнопку "Ответить" открывается страница создания письма с заполненным адресатом
     - При нажатии на кнопку "Во входящие" письмо перемещается в папку "Входящие"
     - При нажатии на кнопку "В исходящие" письмо перемещается в папку "Исходящие"
     - При нажатии на кнопку "В спам" письмо перемещается в папку "Спам" и все письма, которые приходят от отправителя данного письма попадают в папку "Спам"
     - При нажатии на кнопку "В корзину" письмо перемещается в папку "Корзина"
       - При открытии папки "Корзина" к письмам лежащим в ней добавляется опция "Удалить"
     - При нажатии на кнопку "В другую папку" всплывает окно со списком ранее созданных папок, в одну из которых будет перемещено письмо по выбору пользователя
 - При наведении на письмо появляются кнопки выделения письма и кнопка статуса письма:
   - При нажатии на кнопку выделения письма:
     - На письмо распространяются все действия как при нажатии на правую кнопку мыши
   - При нажатии на кнопку статуса письма:
     - Письмо становится прочитанным/непрочитанным
 - При нажатии на кнопку "Выделить все":
   - На выделенные 1...n писем распространяются все действия при нажатии на правую кнопку мыши
 - При нажатии на кнопку "Фильтр" появляется окно с кнопками:
   ...
   - **Улучшение**: Мало действий при нажатии на кнопку "Фильтр"
