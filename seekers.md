...
- При неправильных авторизационных при нажатии "Войти" появляется сообщение "Неправильный пароль"
...
**Стандартные папки**
 ...
 - При нажатии на кнопку "Черновик" открывается список писем, которые сохрани, но еще не отправил
...
**Действия с письмами**
 ...
 - При нажатии на кнопку "Выделить все" или соответсвующий checkbox выделяется 1...n писем:
   - На выделенные 1...n писем распространяются все действия при нажатии на левую кнопку мыши
 - При нажатии на кнопку "Фильтр" письма можно отсортировать от более новых к старым или от более старых к новым
